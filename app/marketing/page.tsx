...
export default function Marketing() {
  ...
  return (
    <>
      ...
      <div className="absolute z-50 -mt-32 shadow-2xl shadow-violet-500 blur-2xl opacity-10 md:h-96 md:w-96 w-56 h-56 bg-violet-600 top-0 rounded-full mx-auto left-0 right-0"></div>
