...
export default function Home() {
  return (
    <>
      ...
      <div className="">
        <section className="relative z-10 w-full py-6 overflow-visible">
          ...
          <Image className="hidden -z-10 lg:block object-none mx-auto absolute top-96 inset-0" src={pattern} alt="" />
        </section>
      </div>
    </>
  )
