          ...
          <div className="bg-white px-6 py-32 lg:px-8">
            <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
              ...
              <p className="mt-6 text-xl leading-8">
                Agencja digital marketingu z unikalną perspektywą. Prowadzenie firmy jest trudne. Spędzasz całe dnie na zarządzaniu ludźmi i strategią marketingową, zamiast skupić się na pracy, którą kochasz. Pozwól nam zająć się tym za Ciebie.
              </p>
