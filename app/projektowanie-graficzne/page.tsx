...
export default function Design() {
  return (
    <>
      ...
      <div className="absolute z-50 -mt-32 shadow-2xl shadow-green-500 blur-2xl opacity-10 md:h-96 md:w-96 w-56 h-56 bg-green-600 top-0 rounded-full mx-auto left-0 right-0"></div>
      <div className="relative">
        ...
        <section className="relative z-10 max-w-7xl mx-auto py-6">
          ...
          <div className="relative flex lg:flex-row flex-col-reverse lg:py-20 lg:space-y-0 items-center justify-between px-4 mx-auto container md:px-12 2xl:px-0 lg:max-w-screen-2xl">
            <div className="space-y-8 lg:-mt-28 max-w-lg 2xl:max-w-2xl relative z-20 w-full mt-10">
              <h1
