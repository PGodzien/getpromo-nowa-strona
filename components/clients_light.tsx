...
import pzl from "@/public/polski-zwiazek-lowiecki-logo-black.png";
import prr from "@/public/polskie-radio-rzeszow-logo-black.png";
import hospicjum from "@/public/hospicjum-logo-black.png";
import szwendamsie from "@/public/szwendam-sie-logo-black.png";
import gg from "@/public/ggauto-logo-black.png";
import rib from "@/public/red-is-bad-logo-black.png";
import merlin from "@/public/merlin-logo-black.png";
import ecocar from "@/public/ecocar-logo-black.png";
    ...
    <div className="bg-gray-50">
      <div className="container xs:max-w-[475px] px-5 mx-auto md:max-w-[768px] lg:max-w-[1200px]">
        <div className="flex flex-col items-center pt-16 pb-16">
          <h3 className="mb-10 text-3xl sm:text-4xl font-serif font-semibold lg:mb-24">
            Nasi klienci
          </h3>
          <div className="flex flex-wrap items-center mx-auto mb-10 max-w-7xl md:mb-12 lg:mb-24">
            <div className="flex items-center justify-center w-1/2 border-r border-gray-300 md:w-1/4 lg:w-1/8 h-28">
              <Image
            ...
            <div className="flex items-center justify-center w-1/2 md:border-r border-gray-300 md:w-1/4 lg:w-1/8 h-28">
              <Image
            ...
            <div className="flex items-center justify-center w-1/2 border-r border-gray-300 md:mt-12 md:w-1/4 lg:w-1/8 h-28">
              <Image
            ...
            <div className="flex items-center justify-center w-1/2 md:border-r border-gray-300 md:mt-12 md:w-1/4 lg:w-1/8 h-28">
              <Image
          ...
          <div className="flex relative">
              ...
              <a href="#kontakt" className="flex items-center">
                <div className="relative overflow-clip border border-black z-10 group flex">
                  ...
                  <div className="relative group-hover:bg-transparent bg-transparent border-r border-black h-16">
                    <p className="flex relative z-20 items-center justify-center h-16 px-8 font-serif text-black font-semibold text-center group-hover:text-primary">
                      skontaktuj się</p>
                  </div>
            ...
            <div className="absolute top-1/2 transform -translate-y-1/2 w-24 -left-24 h-[1px] bg-black"></div>
          </div>
